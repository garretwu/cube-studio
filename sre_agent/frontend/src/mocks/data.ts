...
export const topologyNodes: OntologyNode[] = [
  ...
  },
  {
    ...
    entity_type: "switch",
    name: "Core Switch 01",
    properties: { vendor: "H3C", role: "core" },
    status: "healthy",
...
export const alerts: Alert[] = [
  {
    ...
    annotations: { summary: "p95 latency above threshold", entity: "svc-vllm" },
  ...
  },
  {
    ...
    annotations: { summary: "GPU temperature is high", entity: "gpu-01" },
...
export const alertClusters: AlertCluster[] = [
  {
    ...
    summary: "Latency spike correlates with GPU thermal pressure",
    severity: "critical",
...
export const diagnosisSession: DiagnosisSession = {
  ...
  diagnosis_result: {
    ...
    hypotheses: [
      {
        description: "RoCE congestion",
        status: "eliminated",
        evidence_for: ["short ECN burst"],
        evidence_against: ["switch queue depth healthy"],
        confidence: 0.28,
      },
      {
        description: "GPU process contention",
        status: "confirmed",
        evidence_for: ["dcgm process list contains gpu-burn", "utilization locked at 92%"],
        evidence_against: [],
        confidence: 0.93,
      },
    ],
    impact_summary: "Single shard saturation amplified service latency.",
    ...
    steps: [
      {
        ...
        thought: "Correlate latency alert with blast radius first.",
      ...
      },
      {
        ...
        result: { value: 0.92, trend: "up" },
        timestamp: "2026-03-18T12:00:32Z",
      },
      {
        step: 2,
        timestamp: "2026-03-18T12:00:48Z",
        thought: "Signals point to local GPU contention.",
...
export const initialChatMessages: ChatMessage[] = [
  {
    id: "chat-1",
    role: "assistant",
    content: "I have loaded current topology and active alerts. Ask me to diagnose or remediate.",
...
export const knowledgeDocuments: KnowledgeDocument[] = [
  {
    ...
    category: "hardware",
    excerpt: "Keep ECN and PFC configuration consistent across switches.",
    tags: ["roce", "ecn", "rdma"],
    score: 0.91,
  },
  {
    ...
    category: "runbook",
    excerpt: "Drain canary traffic, stop rogue process, then scale back gradually.",
...
export const learnedPatterns: LearnedPattern[] = [
  {
    ...
    root_cause: "GPU contention",
    effective_fix: "Drain hotspot shard then stop gpu-burn process.",
    occurrence_count: 4,
    confidence: 0.75,
...
export const skills: SkillDescriptor[] = [
  {
    ...
    scope: "builtin",
    summary: "Summarize blast radius and highlight dependency chains.",
    source: "builtin://topology",
    permissions: ["read:ontology", "read:events"],
    match_score: 0.96,
  },
  {
    id: "custom-rdma-runbook",
    name: "RDMA Runbook Matcher",
    scope: "custom",
    summary: "Match alert signatures to RDMA runbook steps.",
