...
export default function RemediationDetailDrawer({
  ...
  const displayOverallProgress = shouldAutoPlayExecution && timelinePlayback.totalCount > 0
    ? Math.round((displayCompletedSteps / Math.max(displayTotalSteps, 1)) * 100)
    : overallProgress;
        ...
        <div className="remediation-sidepanel__scroll">
          ...
          <section className="remediation-panel-section remediation-panel-section--timeline">
            ...
            <RemediationTimeline
              ...
              autoPlay={shouldAutoPlayExecution}
