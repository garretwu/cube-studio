...
describe("DiagnosisModifiedPage sequential playback", () => {
  ...
  it("keeps active thinking title in the header position without duplicate body copy", async () => {
    ...
    expect(screen.getByRole("heading", { name: "Agent reasoning in progress" })).toBeInTheDocument();
    expect(screen.getAllByText("Agent reasoning in progress")).toHaveLength(1);
  });
