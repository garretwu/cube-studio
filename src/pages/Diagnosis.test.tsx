...
describe("DiagnosisPage", () => {
  ...
  it("runs step1 then streams step2 with grouped conclusion and collapsible thinking", async () => {
    ...
    await waitFor(
      () => {
        expect(screen.getByText(/\u63a8\u7406\u5df2\u6536\u8d77/)).toBeInTheDocument();
      },
      { timeout: 6000 },
    );

    await user.click(screen.getByRole("button", { name: /\u5c55\u5f00\u63a8\u7406/ }));
    expect(screen.getByText(/The user wants me to diagnose/)).toBeInTheDocument();
    expect(screen.queryByText(/\u4e0b\u4e00\u6b65\u5de5\u5177\u9009\u62e9/)).not.toBeInTheDocument();
  }, 15000);
