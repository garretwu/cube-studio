"""
Shared scenario-dispatch implementation used by layer agents.
"""
...
class ScenarioDispatchAgent(BaseAgent):
    """Layer agent that dispatches to registered scenarios."""

    def __init__(self, name: str, layer: str, channels: dict[str, Any] | None = None):
        super().__init__(name=name, layer=layer, channels=channels)
