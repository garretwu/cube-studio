...
Load Simulator 使用以下 Channel：

| Channel | 用途 | 详见 |
|---------|------|------|
| **CubeStudioChannel** | 推理服务/Pipeline/Notebook 生命周期管理 | channel.md §3.1 |
| **InferenceChannel** | 推理端点直连，高并发压测 | channel.md §4.1 |
| **PrometheusChannel** | 指标采集与查询 | channel.md §3.2 |
| **NotebookChannel** | Jupyter Kernel 直接操作 | channel.md §4.2 |
